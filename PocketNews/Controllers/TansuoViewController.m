...
#import "MJRefresh.h"
@interface TansuoViewController ()
{
...
@implementation TansuoViewController
- (void)dealloc
{
    [header free];
    [footer free];
...
-(void)loadData
{
    NSString *str = [NSString stringWithFormat:Ktansuo,_pageSize];
